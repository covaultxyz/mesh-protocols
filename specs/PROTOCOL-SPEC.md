...
**State requirements:** prospect_id, known_data, gaps[], org_confidence
...
2. **CC model** — related_agents array for visibility, not action
3. **Escalation path** — If confidence < 0.5, Evelyn asks clarifying question before routing
4. **Fallback** — If primary unavailable (V2), route to fallback_agent
...
- Activity Log schema: Reference Cassian's schema
- Intelligence Layer: Reference Sandman's spec
